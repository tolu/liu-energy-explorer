...
class PHPExcel_Calculation {
	...
	public function calculate(PHPExcel_Cell $pCell = null) {
		...
		for($i = 0; $i < $tokenCount; ++$i) {
			...
			if (($tokenType == PHPExcel_Calculation_FormulaToken::TOKEN_TYPE_OPERAND) && ($tokenSubType == PHPExcel_Calculation_FormulaToken::TOKEN_SUBTYPE_RANGE) && (strpos ($tokenValue, ':' ) === false) ) {
 				// Adjust reference
