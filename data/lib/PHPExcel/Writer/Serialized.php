...
class PHPExcel_Writer_Serialized implements PHPExcel_Writer_IWriter
{
	...
	private function _writeSerialized(PHPExcel $pPHPExcel = null, $pFilename = '')
	{
		...
		$objWriter->writeAttribute('version', '1.6.5');

			// Comment
			$objWriter->writeComment('This file has been generated using PHPExcel v1.6.5 (http://www.codeplex.com/PHPExcel). It contains a base64 encoded serialized version of the PHPExcel internal object.');
